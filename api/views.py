...
class TransactionViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        # Sellers can see transactions for their properties
        elif user.role == 'seller':
            return Transaction.objects.filter(property__seller=user)
    ...
    def total(self, request):
        ...
        if user.role == 'admin':
            ...
            transactions = Transaction.objects.filter(property__seller=user)
        else:
